CREATE TABLE projects(
  ...
  owner_id integer,
  name varchar(50),
  is_sample_project Boolean DEFAULT false board_height integer NOT NULL,
  board_width integer NOT NULL,
  board_x integer NOT NULL,
  board_y integer NOT NULL,
  board_thumbnail jsonb
);

CREATE TABLE modules (
  id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  project_id FOREIGN KEY (project_id) REFERENCES projects(id) ON UPDATE CASCADE ON DELETE CASCADE,
  module_id varchar(50) NOT NULL,
  price decimal NOT NULL,
  icon_height varchar(50) NOT NULL,
  icon_src varchar(50) NOT NULL,
